<?php
 ...
 $extension = pathinfo($img, PATHINFO_EXTENSION);  //store the extension name
    ...
    $sql = "INSERT INTO `item_info`(`item_name`, `item_dname`, `item_price`, `item_discount`, `item_description`,`item_img`, `item_category`, `reg_date`) 
    VALUES ('$a','$b','$c','$f','$g','$imgname','$e',now())";
